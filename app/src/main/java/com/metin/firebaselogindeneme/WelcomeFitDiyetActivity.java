...
public class WelcomeFitDiyetActivity extends AppCompatActivity {
                    ...
                    mRef.child(mUser.getUid()).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.exists()){
                                ...
                                Intent intent = new Intent(WelcomeFitDiyetActivity.this,LoginActivity.class);
    ...
    public void Login(View view) {
        startActivity(new Intent(WelcomeFitDiyetActivity.this,LoginAsilActivity.class));
    }

    public void register(View view) {
        startActivity(new Intent(WelcomeFitDiyetActivity.this, fit1Activity.class));
    }
