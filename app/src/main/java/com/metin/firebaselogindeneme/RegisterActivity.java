...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnkayitolmadan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(RegisterActivity.this, ValueActivity.class));
            }
        });
    }
    ...
    private void SaveData(){
        ...
        String kilos = fit2Activity.kilos;
        String tall = fit3Activity.tall;
        String fatmass= fit4Activity.fatmass;
        String frequency = fit5Activity.frequency;
        String exercise = fit6Activity.exercise;
        String purpose = fit7Activity.purpose;
            ...
            if (mUser == null){
                ...
                mRef.child(mUser.getUid()).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Intent intent = new Intent(RegisterActivity.this, ValueActivity.class);
                        startActivity(intent);
                        mLoadingBar.dismiss();
