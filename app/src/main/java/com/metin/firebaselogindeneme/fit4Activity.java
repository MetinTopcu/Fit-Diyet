    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnyes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!fatmass.isEmpty()){
                    ValueActivity valueActivityActivity = new ValueActivity();
                    valueActivityActivity.Howfitmass = Integer.parseInt(fatmass);
                    LoginActivity loginActivity = new LoginActivity();
                    loginActivity.fatmasslogin = Integer.parseInt(fatmass);
                    startActivity(new Intent(fit4Activity.this, fit5Activity.class));
                }
                else {
                    Toast.makeText(fit4Activity.this, "İçleri boş method", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
